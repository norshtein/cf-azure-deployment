...
resource "azurerm_virtual_machine" "bastion" {
  ...
  os_profile {
    ...
    custom_data = <<CUSTOM_DATA
    {
      ...
      "BOSH_AZURE_CPI_RELEASE_URL":"https://opensourcerelease.blob.core.windows.net/internalreleases/bosh-azure-cpi-release.tgz",
      "BOSH_AZURE_CPI_RELEASE_SHA1":"f233eb3b4d963f344fd5d87226f5f3abd7640712",
      "STEMCELL_URL":"https://bosh.io/d/stemcells/bosh-azure-hyperv-ubuntu-trusty-go_agent?v=3586.23",
      "STEMCELL_SHA1":"b44edd2937157e266746b804cac2f2a257d52687",
